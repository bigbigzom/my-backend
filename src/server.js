...
import { generateMainCopy, generateSubCopy, generateDialogue, generateNurtureCopy, semanticRewrite } from './utils/content-rewriter.js';
...
async function main() {
  console.log(`
╔══════════════════════════════════════════════════════════╗
║   Bilibili Comment Target Backend v2.2.0                  ║
